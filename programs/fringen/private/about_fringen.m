function varargout=about_fringen(src,varargin)

mode='window';
rootfig=ancestor(src,'figure');             

name='fringen (Fringe generator)';
codever='0.3';
...
switch mode
    ...
    otherwise
        ...
        message={};
        message{end+1}='This program calculates VISAR and PDV signals for a specified velocity history.';
