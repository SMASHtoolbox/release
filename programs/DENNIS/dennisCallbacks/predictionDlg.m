...
% set(h_button, 'Callback', {@predictionButton, mainFigure, h_radio});
...
% function predictionButton(src, event, mainFigure, h_radio)
% 
% obj = get(mainFigure, 'UserData');
% set(h_radio(1:2), 'Value', 0);
% 
% obj = changeObject(obj, 'prediction', 'type', 'monte carlo');
% set(mainFigure, 'UserData', obj);
% updatePlotPredictionAnalysis(mainFigure);
% 
% end
