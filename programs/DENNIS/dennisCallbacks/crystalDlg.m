...
set(h_latSizeSlider(2), 'Value', 1);
set(h_latSizeSlider(3), 'String', '1');
...
obj = changeObject(obj, 'crystal', 'lengths', ...
    sliderVal * obj.crystal.lengthsReference);
set(mainFigure, 'UserData', obj);
...
obj = changeObject(obj, 'crystal', 'lengths', ...
    sliderVal * obj.crystal.lengthsReference);
set(mainFigure, 'UserData', obj);
set(h_slider(2), 'Value', sliderVal);
set(h_slider(3), 'String', num2str(sliderVal));
