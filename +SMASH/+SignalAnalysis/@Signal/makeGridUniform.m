% makeGridUniform Enforce uniform Signal grid
%
%    >> object=makeGridUniform(object);
%
% See also Signal, verifyGrid
%

%
% created November 18, 2013 by Daniel Dolan (Sandia National Laboratories)
%
function object=makeGridUniform(object)

if isempty(object.GridUniform)
