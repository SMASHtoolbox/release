% SGderivative : calculate a smooth derivative using the Savitzky-Golay
...
%
% Standard usage:
%   >>dydx=SGderivative(1,param,y,x);
%   >>ys=SGderivative(0,param,y,x);
%   >>[ys,dydx]=SGderivative([0 1],param,y,x);
%
% Advanced usage:
...
%   >>[dydx,param]=SGderivative(1,param,y,x);
...
function varargout=SGderivative(deriv,param,y,x) 
