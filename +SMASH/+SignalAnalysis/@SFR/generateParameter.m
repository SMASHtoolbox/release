...
parameter.EffectiveTime=object.EffectiveTime;

width=object.Window.BandwidthCorrection/object.EffectiveTime;
...
parameter.TransformFcn=@(x) object.calculateFFT(x,object.TransformPoints);
