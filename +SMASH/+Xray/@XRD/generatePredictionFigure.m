...
if isempty(obj.prediction.spotLocations)
    ...
    disp('No prediction detected: generated temporary prediction for plotting')
...
x = x/psize(2) + 0.5;
y = y/psize(1) + 0.5; % +0.5 necessary b/c view() actually starts at 0.5,0.5 instead of 0,0
