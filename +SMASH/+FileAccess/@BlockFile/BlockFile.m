% BlockFile Class for accessing text information arranged in column blocks
%
%    object=BlockFile([filename]);
%
% See also FileAccess
%

%
% created October 6, 2016 by Daniel Dolan (Sandia National Laboratories)
% 
...
%
classdef BlockFile < SMASH.FileAccess.File
    ...
    methods (Hidden=true)
        function object=BlockFile(filename)           
