...
if all(byte_order_verification == '0F0F')
...
ed1.units=strtrim(transpose(dummy));
...
ed1.user_units = char(fread(fid,20,'*uchar',byteorder)');
...
ed2.units=strtrim(transpose(dummy));
...
ed2.user_units = char(fread(fid,20,'*uchar',byteorder)');
...
id1.units = char(fread(fid,20,'*uchar',byteorder)');
...
id1.user_units = char(fread(fid,20,'*uchar',byteorder)');
...
id2.units = char(fread(fid,20,'*uchar',byteorder)');
...
id2.user_units = char(fread(fid,20,'*uchar',byteorder)');
